  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] p-0 gap-0 max-h-[80vh] overflow-hidden">
        ...
        <div className="grid grid-cols-1 gap-8 p-6 overflow-y-auto max-h-[60vh]">
          {plans.map((plan) => (
            <div 
              key={plan.name}
            ...
            >
              ...
              {/* Main Content Box */}
              <div className="relative border-2 border-foreground dark:border-foreground/50 bg-background/50 p-5 -mt-0.5 flex-1 flex flex-col min-h-[250px]">
                {plan.current && (
